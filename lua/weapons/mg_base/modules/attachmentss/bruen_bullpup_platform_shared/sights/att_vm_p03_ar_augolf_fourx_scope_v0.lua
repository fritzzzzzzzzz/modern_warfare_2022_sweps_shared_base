...
ATTACHMENT.Model = Model("models/zeron/att_vm_p03_ar_augolf_fourx_scope_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/auggers/icons/icon_attachment_p03_ar_augolf_fourx_scope_v0.vmt")
--ATTACHMENT.Icon = Material("easy/cw/attachments/icons/nato/icon_attachment_optic_scope3x_t9.vmt")
...
ATTACHMENT.Optic = {
    ...
    HideModel = Model("models/zeron/att_vm_p03_ar_augolf_fourx_scope_v0_hide.mdl"),
    LensBodygroup = "lens",
    FOV = 3, 
...
ATTACHMENT.Reticle = {
    Material = Material("zeron/reticles/iw9_augolf_reticle.vmt"),
    Size = 1400,
