...
ATTACHMENT.Name = "Forge DX30-S"
ATTACHMENT.Model = Model("models/zeron/att_vm_silencer_pi04_v0.mdl")
ATTACHMENT.Icon = Material("pwci/mw/attachments/icons/shared/icon_attachment_silencer_pi04_v0.vmt")
