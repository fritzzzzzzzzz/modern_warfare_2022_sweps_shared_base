...
ATTACHMENT.Name = "TV Cardinal Stock"
ATTACHMENT.Model = Model("models/zeron/att_vm_p05_ar_scsierra_stock_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/taq/icons/icon_attachment_p05_ar_scsierra_stock_v0.vmt")
