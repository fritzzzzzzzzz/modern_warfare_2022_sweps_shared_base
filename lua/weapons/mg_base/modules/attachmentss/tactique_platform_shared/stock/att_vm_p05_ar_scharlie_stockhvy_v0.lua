...
ATTACHMENT.Name = "Tactique Brute Stock"
ATTACHMENT.Model = Model("models/zeron/att_vm_p05_ar_scharlie_stockhvy_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/taq/icons/icon_attachment_p05_ar_scharlie_stockhvy_v0.vmt")
