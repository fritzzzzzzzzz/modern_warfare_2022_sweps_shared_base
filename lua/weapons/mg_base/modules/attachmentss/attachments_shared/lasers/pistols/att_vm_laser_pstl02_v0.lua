...
ATTACHMENT.Name = "Series 710 Pistol Laser"
ATTACHMENT.Model = Model("models/zeron/att_vm_laser_pstl02_v0.mdl")
ATTACHMENT.Icon = Material("pwci/mw/attachments/icons/shared/icon_attachment_laser_pstl02_v0.vmt")
