...
ATTACHMENT.Name = "1mW Pistol Laser"
ATTACHMENT.Model = Model("models/zeron/att_vm_laser_pstl06_v0.mdl")
ATTACHMENT.Icon = Material("pwci/mw/attachments/icons/shared/icon_attachment_laser_pstl06_v0.vmt")
