...
ATTACHMENT.Model = Model("models/zeron/att_vm_p04_ar_akilo_stockh_v0.mdl")
ATTACHMENT.Name = "Ivanov Wood Stock"
ATTACHMENT.Icon = Material("zeron/weapons/vepr/icons/icon_attachment_p04_ar_akilo_stockh_v0.vmt")
