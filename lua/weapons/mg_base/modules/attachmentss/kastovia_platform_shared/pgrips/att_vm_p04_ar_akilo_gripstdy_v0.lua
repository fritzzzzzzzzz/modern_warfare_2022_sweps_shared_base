...
ATTACHMENT.Name = "Ivanov ST-70 Grip"
ATTACHMENT.Model = Model("models/zeron/att_vm_p04_ar_akilo_gripstdy_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/vepr/icons/icon_attachment_p04_ar_akilo_gripstdy_v0.vmt")
