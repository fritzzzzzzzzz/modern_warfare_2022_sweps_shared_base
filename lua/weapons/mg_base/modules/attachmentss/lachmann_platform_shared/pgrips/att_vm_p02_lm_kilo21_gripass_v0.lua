...
ATTACHMENT.Name = "Lachmann TCG-10"
ATTACHMENT.Model = Model("models/zeron/att_vm_p02_lm_kilo21_gripass_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/lachmann/icons/icon_attachment_p02_ar_kilo53_pstlgrp_v0.vmt")
