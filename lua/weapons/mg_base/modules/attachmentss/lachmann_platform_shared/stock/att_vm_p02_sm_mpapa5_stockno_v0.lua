...
ATTACHMENT.Model = Model("models/zeron/att_vm_p02_sm_mpapa5_stockno_v0.mdl")
ATTACHMENT.Icon = Material("zeron/weapons/lachmann/icons/icon_attachment_p02_sm_mpapa5_stockno_v0.vmt")
